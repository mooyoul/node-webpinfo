  ...
  private readWebPChunk(memo: WebPChunk[] = []): any { // sadly thunk typing is not good
    ...
    return this.readBytes(8)((e: Error, buf: Buffer) => {
      ...
      if (Buffer.compare(BUF_VP8, bufChunkType) === 0) {
        return this.readVP8Bitstream()((err: Error, bitstream: VP8Bitstream): VP8Chunk => {
          if (err) {
            throw err;
          }
        ...
        return this.readVP8LBitstream()((err: Error, bitstream: VP8LBitstream): VP8LChunk => {
          if (err) {
            throw err;
          }
        ...
        return this.readVP8XBitstream()((err: Error, bitstream: VP8XBitstream): VP8XChunk => {
          if (err) {
            throw err;
          }
        ...
        return this.readANIMBitstream()((err: Error, bitstream: ANIMBitstream): ANIMChunk => {
          if (e) {
            throw e;
          }
        ...
        return this.readANMFBitstream()((err: Error, bitstream: ANMFBitstream): ANMFChunk => {
          if (e) {
            throw e;
          }
        ...
        return this.readALPHBitstream()((err: Error, bitstream: ALPHBitstream): ALPHChunk => {
          if (e) {
            throw e;
          }
